...
import cn.edu.bupt.OcrApp.dto.ResponseInfo;
import cn.edu.bupt.OcrApp.dto.Token;
import cn.edu.bupt.common.utils.ResponseUtil;
	...
	public AccessDeniedHandler accessDeniedHandler(){
		return new AccessDeniedHandler() {
			...
			public void handle(HttpServletRequest httpServletRequest, HttpServletResponse response, AccessDeniedException accessDeniedException) throws IOException, ServletException {
				ResponseInfo info = new ResponseInfo(HttpStatus.FORBIDDEN.value() + "", "未授权");
				ResponseUtil.responseJson(response, HttpStatus.FORBIDDEN.value(), info);
			}
		};
	}
